...
model_name = 'improved_keras_3_cifar10_trained_model.h5'
...
plt.savefig(os.path.join('model_history', 'improved_keras_3_CIFAR10_model_accuracy.png'))
plt.clf()  # clear plot
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig(os.path.join('model_history', 'improved_keras_3_CIFAR10_model_loss.png'))
