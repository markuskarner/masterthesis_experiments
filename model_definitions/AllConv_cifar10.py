...
def _define_model():
    ...
    _model.add(Conv2D(filters=96, kernel_size=(3, 3), strides=(1, 1)
                      ...
                      , activation='relu'))
    _model.add(Conv2D(96, (3, 3), activation='relu'))
    _model.add(Conv2D(96, (3, 3), strides=(2, 2), activation='relu'))
    _model.add(Conv2D(192, (3, 3), activation='relu'))
    _model.add(Conv2D(192, (3, 3), activation='relu'))
    _model.add(Dropout(0.3))
    _model.add(Conv2D(192, (3, 3), strides=(2, 2), activation='relu'))
    _model.add(Conv2D(192, (3, 3), strides=(2, 2), activation='relu'))
    _model.add(Conv2D(192, (1, 1), activation='relu'))
    _model.add(Conv2D(10, (1, 1), activation='relu'))
